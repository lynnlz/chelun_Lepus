...
<html lang="en">
  <head>
    ...
    <script src="lib/dataTableStyle.js"></script>
    <style type="text/css">
        #line-chart {
            height:300px;
            width:800px;
...
<div class="content">
       <?php echo $content_for_layout ; ?>
                    ...
                    <footer>
                        ...
                        <p class="pull-right">Power by <a href="http://op.oa.com" target="_blank">车轮运维</a></p>

                        <!-- p>&copy; 2014 <a href="http://www.lepus.cc" target="_blank">Lepus</a>(车轮天兔数据库监控系统)</p -->
                        <p>&copy; 2017 <a href="http://op.oa.com" target="_blank">车轮运维</a>(车轮天兔数据库监控系统)</p>
                    </footer>
